...
#define PATH#"/Users/giuliodemattia/Documents/campana/catalogo/rec/CapovoltoAlCentro.wav"#
//CapovoltoAlCentro
t 0 $BPM
{ $COUNTER CNT
i1	[($MIN_VALUE_TIME * $COUNTER * $COUNTER) - ($MIN_VALUE_TIME) * ($CNT. * $CNT.)] .3 $PATH 15
}
{ $COUNTER2 CNT
