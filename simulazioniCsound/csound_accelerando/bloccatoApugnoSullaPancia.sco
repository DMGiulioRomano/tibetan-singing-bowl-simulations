...
#define PATH#"/Users/giuliodemattia/Documents/campana/catalogo/rec/bloccatoApugnoSullaPancia.wav"#
//bloccatoApugnoSullaPancia
t 0 $BPM
{ $COUNTER CNT
i1	[($MIN_VALUE_TIME * $COUNTER * $COUNTER) - ($MIN_VALUE_TIME) * ($CNT. * $CNT.)] .3 $PATH 5.45
}
{ $COUNTER2 CNT
